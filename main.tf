provider "aws" {
 ...
 module "subnets" {
	...
	sec_web_id		= module.vpc.sec_web_id
	...
	sec_allow_jenkins_to_manager_ssh_id = module.vpc.sec_allow_jenkins_to_manager_ssh_id
	sec_application_ports_id			= module.vpc.sec_application_ports_id
